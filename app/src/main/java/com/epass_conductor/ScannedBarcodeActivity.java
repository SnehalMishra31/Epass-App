...
public class ScannedBarcodeActivity extends AppCompatActivity {
    ...
    private void checkApplicationStatus(final String val) {
...
//                        progressDialog.dismiss();
                        ...
                        if (snapshot != null && snapshot.exists()) {
                            ...
                            if (time >= System.currentTimeMillis()) {
                                ...
                                EpassModel epassModel=snapshot.toObject(EpassModel.class);
                                Intent intent=new Intent(ScannedBarcodeActivity.this,SuccessActivity.class);
                                intent.putExtra("epass",epassModel);
                                intent.putExtra("docid",val);
    ...
    private void showApprovedOrRejectPage(int i) {
     if (i==0){
         Toast.makeText(this, "Invalid Pass or User", Toast.LENGTH_LONG).show();
     }
    }
